...
echo "  cd ${APP_DIR}"
echo "  sudo nano .env"
echo "  sudo ./scripts/preflight-staging.sh"
echo "  sudo ./scripts/backup-staging.sh"
echo "  sudo HEALTH_URL=https://api-domain/health ./scripts/deploy-staging.sh"
echo "  sudo HEALTH_URL=https://api-domain/health ./scripts/status-staging.sh"
