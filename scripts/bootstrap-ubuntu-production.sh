...
RELEASE_REF="${RELEASE_REF:-launch-candidate-2026-06-21-r10}"
...
echo "  cd ${APP_DIR}"
echo "  sudo nano .env"
echo "  sudo ./scripts/preflight-production.sh"
echo "  sudo HEALTH_URL=https://api-domain/health ./scripts/launch-production.sh"
echo "  sudo HEALTH_URL=https://api-domain/health ./scripts/status-production.sh"
