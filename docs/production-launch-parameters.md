...
sudo RELEASE_REF=launch-candidate-2026-06-21-r13 bash bootstrap-ubuntu-production.sh
```
...
Final approval templates are available in [accreditation-launch-signoff-pack.md](./accreditation-launch-signoff-pack.md).
