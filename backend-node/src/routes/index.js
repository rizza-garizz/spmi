...
router.get("/accreditation/summary", verifyToken, requireRole(...ROLE_ACCREDITATION_READ), catchAsync(compatController.accreditationSummary));
router.get("/accreditation/periods", verifyToken, requireRole(...ROLE_ACCREDITATION_READ), catchAsync(compatController.accreditationPeriods));
router.post("/accreditation/periods", verifyToken, requireRole(...ROLE_ACCREDITATION_WRITE), catchAsync(compatController.createAccreditationPeriod));
router.get("/accreditation/instruments", verifyToken, requireRole(...ROLE_ACCREDITATION_READ), catchAsync(compatController.accreditationInstruments));
router.post("/accreditation/instruments", verifyToken, requireRole(...ROLE_LPM_ADMIN), catchAsync(compatController.createAccreditationInstrument));
router.get("/accreditation/criteria", verifyToken, requireRole(...ROLE_ACCREDITATION_READ), catchAsync(compatController.accreditationCriteria));
router.post("/accreditation/criteria", verifyToken, requireRole(...ROLE_LPM_ADMIN), catchAsync(compatController.createAccreditationCriterion));
router.get("/accreditation/assessments", verifyToken, requireRole(...ROLE_ACCREDITATION_READ), catchAsync(compatController.accreditationAssessments));
router.post("/accreditation/assessments", verifyToken, requireRole(...ROLE_ACCREDITATION_WRITE), catchAsync(compatController.createAccreditationAssessment));
router.get("/accreditation/team-members", verifyToken, requireRole(...ROLE_ACCREDITATION_READ), catchAsync(compatController.accreditationTeamMembers));
router.post("/accreditation/team-members", verifyToken, requireRole(...ROLE_ACCREDITATION_WRITE), catchAsync(compatController.createAccreditationTeamMember));
router.get("/accreditation/tasks", verifyToken, requireRole(...ROLE_ACCREDITATION_READ), catchAsync(compatController.accreditationTasks));
router.post("/accreditation/tasks", verifyToken, requireRole(...ROLE_ACCREDITATION_WRITE), catchAsync(compatController.createAccreditationTask));
router.get("/accreditation/milestones", verifyToken, requireRole(...ROLE_ACCREDITATION_READ), catchAsync(compatController.accreditationMilestones));
router.post("/accreditation/milestones", verifyToken, requireRole(...ROLE_ACCREDITATION_WRITE), catchAsync(compatController.createAccreditationMilestone));
router.get("/accreditation/risks", verifyToken, requireRole(...ROLE_ACCREDITATION_READ), catchAsync(compatController.accreditationRisks));
router.post("/accreditation/risks", verifyToken, requireRole(...ROLE_ACCREDITATION_WRITE), catchAsync(compatController.createAccreditationRisk));
router.patch("/accreditation/risks/:id", verifyToken, requireRole(...ROLE_ACCREDITATION_WRITE), catchAsync(compatController.updateAccreditationRiskRecord));
router.get("/accreditation/evidence", verifyToken, requireRole(...ROLE_ACCREDITATION_READ), catchAsync(compatController.accreditationEvidence));
router.post("/accreditation/evidence", verifyToken, requireRole(...ROLE_ACCREDITATION_WRITE), upload.single("file"), catchAsync(compatController.createAccreditationEvidence));
router.get("/accreditation/lkps", verifyToken, requireRole(...ROLE_ACCREDITATION_READ), catchAsync(compatController.accreditationLkps));
router.post("/accreditation/lkps/entries", verifyToken, requireRole(...ROLE_ACCREDITATION_WRITE), catchAsync(compatController.createAccreditationLkpsEntry));
router.get("/accreditation/led", verifyToken, requireRole(...ROLE_ACCREDITATION_READ), catchAsync(compatController.accreditationLed));
router.post("/accreditation/led/contents", verifyToken, requireRole(...ROLE_ACCREDITATION_WRITE), catchAsync(compatController.createAccreditationLedContent));
router.get("/accreditation/self-scores", verifyToken, requireRole(...ROLE_ACCREDITATION_READ), catchAsync(compatController.accreditationSelfScores));
router.post("/accreditation/self-scores", verifyToken, requireRole(...ROLE_ACCREDITATION_WRITE), catchAsync(compatController.createAccreditationSelfScore));
router.get("/accreditation/action-plans", verifyToken, requireRole(...ROLE_ACCREDITATION_READ), catchAsync(compatController.accreditationActionPlans));
router.post("/accreditation/action-plans", verifyToken, requireRole(...ROLE_ACCREDITATION_WRITE), catchAsync(compatController.createAccreditationActionPlan));
router.post("/accreditation/action-plans/bulk", verifyToken, requireRole(...ROLE_ACCREDITATION_WRITE), catchAsync(compatController.createAccreditationActionPlansBulk));
router.patch("/accreditation/action-plans/:id", verifyToken, requireRole(...ROLE_ACCREDITATION_WRITE), catchAsync(compatController.updateAccreditationActionPlanRecord));
router.get("/accreditation/reviews", verifyToken, requireRole(...ROLE_ACCREDITATION_READ), catchAsync(compatController.accreditationReviews));
router.post("/accreditation/reviews", verifyToken, requireRole(...ROLE_ACCREDITATION_REVIEW), catchAsync(compatController.createAccreditationReview));
router.get("/accreditation/submission-checks", verifyToken, requireRole(...ROLE_ACCREDITATION_READ), catchAsync(compatController.accreditationSubmissionChecks));
router.post("/accreditation/submission-checks", verifyToken, requireRole(...ROLE_ACCREDITATION_REVIEW), catchAsync(compatController.createAccreditationSubmissionCheck));
router.post("/accreditation/submission-checks/bulk", verifyToken, requireRole(...ROLE_ACCREDITATION_REVIEW), catchAsync(compatController.createAccreditationSubmissionChecksBulk));
router.patch("/accreditation/submission-checks/:id", verifyToken, requireRole(...ROLE_ACCREDITATION_REVIEW), catchAsync(compatController.updateAccreditationSubmissionCheckRecord));
router.patch("/accreditation/periods/:id/status", verifyToken, requireRole(...ROLE_ACCREDITATION_REVIEW), catchAsync(compatController.updateAccreditationPeriodStatusRecord));
router.get("/accreditation/exports", verifyToken, requireRole(...ROLE_ACCREDITATION_READ), catchAsync(compatController.accreditationExports));
router.post("/accreditation/exports", verifyToken, requireRole(...ROLE_ACCREDITATION_REVIEW), catchAsync(compatController.createAccreditationExport));
router.get("/accreditation/exports/:id/download", verifyToken, requireRole(...ROLE_ACCREDITATION_READ), catchAsync(compatController.downloadAccreditationExport));
