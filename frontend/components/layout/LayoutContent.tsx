    ...
    children: [
      ...
      { id: "nilai", label: "Nilai & Rekap", description: "Rekap capaian, skor, dan ringkasan evaluasi mutu.", href: "/nilai", icon: "la-bar-chart", roles: roleOperator },
      {
        ...
        children: [
          ...
          { id: "accreditation-action-plan", label: "Rencana Perbaikan", description: "Eksekusi gap akreditasi, PIC, target selesai, output, dan progress.", href: "/accreditation#rencana-perbaikan-akreditasi", icon: "la-tools", roles: roleQuality },
